...
if(!empty($_POST['diagnosa'])){
	...
	if($diagnosa_->create($diagnosa,$keterangan,$aktif,$created_by)){
		$sg   = "ok";
		...
		<div class="row-fluid">
			<div class="span6">
				...
				<label class="control-label" for="diagnosa" >Diagnosa</label>
					<div class="controls">
					<textarea class="span12" id="diagnosa" name="diagnosa" required></textarea>
					</div>
				</div>
				<div class="control-group">
