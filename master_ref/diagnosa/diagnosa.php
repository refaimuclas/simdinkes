<script type="text/javascript">
	$(document).ready(function(){
		$("#data").load("master_ref/diagnosa/data_diagnosa.php");
	...
	function tambahForm(){
		...
		$.ajax({
			type:"GET",
			url:"master_ref/diagnosa/tambah_diagnosa.php",
			data:null,
			beforeSend:function(){
	...
	function deleteData(id,diagnosa){
		...
		if(pilih==true){
				$.ajax({
					type:"GET",
					url:'master_ref/diagnosa/hapus_diagnosa.php',
					data:"id_diagnosa="+id,
					beforeSend:function(){
						$("#data").html("<img src='assets/images/ajax-loader.gif' />");
					},
	...
	function editData(id){
		$.ajax({
			type:"GET",
			url:'master_ref/diagnosa/edit_diagnosa.php',
			data:"id_diagnosa="+id,
			beforeSend:function(){
				$("#form-nest").css({display:"block"});
				$("#form").html("<img src='assets/images/ajax-loader.gif' />");
