...
<!-- ================================================= End Navbar Right ================================================== -->
			...
			<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs" >
					...
					<small>
					<span><?php echo "<b> Nama : </b> ". $_SESSION['s_nama']." <b> Level : </b> ". $_SESSION['s_level']." <b>Posko :</b> " ?><?php		
						require_once 'config/koneksi.php';
						include_once 'bantuan/class.bantuan.php';
						$bantuan = new bantuan($pdo);				
						$c = $_SESSION['id_posko'];
						$query = "SELECT * FROM posko where id_posko='$c' ";		
						$bantuan->posko_1($query);
					?></span> 
					</small>
