							...
							<div class="row-fluid">
								<div class="center">
									<h1>
										...
										<span class="blue">SIMDINKES</span>
									</h1>
									<h4 class="blue">Kabupaten Bantul</h4>
								</div>
							</div>
									...
									<div id="login-box" class="login-box visible widget-box no-border">
										<div class="widget-body">
											<div class="widget-main">
												 <div align="center"><img src="assets/images/logo.jpg" class="img-polaroid"/></div>
												 ...
												 <?php
      											...
      											?>
													<fieldset>
														...
														<label class="block clearfix">															
															<label>Modul</label>
															<select  placeholder="Modul..." style="width:100%;">
											...
											<div class="widget-main">
												<div>
													 <span class="lbl">Powered By @ StmikElRahma</span>
												</div>
											</div>
										</div><!--/widget-body-->
									</div><!--/login-box-->
